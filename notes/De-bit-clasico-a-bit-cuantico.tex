...
Si lanzas la moneda y esta cae, al observarla sabes exactamente su valor: o es 0 o es 1; pero nunca ambos, es como si pudieras medir de alguna forma el bit y saber si es 0 o 1. Ahora imagina que la moneda no ha caído aún y está girando en el aire. Mientras gira, no está ni en “cara” ni en ``sello'', sino que digamos está en una mezcla de ambos lados. Esta propiedad de poder estar en esta ``mezcla'' o de coexistir en ambos estados a la vez es una de las propiedades que caracteriza a un \textbf{qubit} o bit cuántico la Unidad Fundamental de Información en Computación Cuántica y provienente de ``quantum'' + ``bit''. Por tanto, si pensamos en un contexto cuántico y consideramos ahora la notación de Dirac \cite{mcmahon2008quantum} para representar los dos posibles lados cara y sello de la moneda, tenemos:
\begin{align*}
	\mbox{cara} & \to \ket{0} \\
	\mbox{sello} & \to \ket{1}
\end{align*}
